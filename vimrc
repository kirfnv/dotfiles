...
Plugin 'scwood/vim-hybrid'              " Colorscheme
"--------------=== Snippets support ===---------------
...
" --- Jade ---
autocmd FileType jade set omnifunc=jadecomplete#CompleteTags
autocmd FileType jade set expandtab shiftwidth=4 tabstop=4 softtabstop=4
